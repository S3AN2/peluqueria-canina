...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //guardar datis del dueño
        String nombreDuenio= txtNombreDuenio.getText();
        String celDuenio= txtCel.getText();
       controlL.modificarMascota(masco,nombreMasco,raza,color,observaciones,alergico,atencion,nombreDuenio,celDuenio);
       //MENSAJE DE TODO OK
        mostrarmensaje("Edicion realizada correcto", "Info", "Edición correcta");
   ...
   JOptionPane optionPane = new JOptionPane("Cancelado", messageType);
    ...
    private void cargardatos(int num_cliente) {
      this.masco=controlL.traerMascota(num_cliente);
